...
//   return (
//     <header
//       className={`fixed top-[90px] w-full z-50 transition-all duration-300${scrolled ? ' shadow-lg' : ''}`}
//       style={scrolled
...
//             src={Logo}
//             alt="Logo"
//             className="h-[122px] w-[124px] cursor-pointer"
//             onClick={() => {
//               setSelected('Home');
//               navigate('/');
//             }}
...
//           <div className="hidden md:flex items-center space-x-4 gap-[30px]">
//             {navLinks.map((link) => {
//               let isActive = false;
...
//                   }}
//                   className={`relative px-1 focus:outline-none text-[22px] ${
...
//                 className="text-[22px] bg-gradient-to-r from-[#7F66FF] to-[#CC66FF] text-white px-6 py-2 rounded-full transition-all duration-200 transform hover:scale-105"
//               >
//                 Get Started
//               </button>
//             )}
      ...
      <div className="mx-auto px-6 py-4">
        <nav className="flex items-center justify-between px-20">
          <LazyLoadImage
            ...
            src={Logo}
            alt="Logo"
            className="h-[122px] w-[170px] cursor-pointer"
            onClick={() => {
              setSelected('Home');
              navigate('/');
            }}
