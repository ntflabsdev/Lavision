...
const RegisterScreen: React.FC<RegisterScreenProps> = ({ onSwitchToLogin }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    setError('');
   // signup ke baad bhi user ko Get Started (HomeScreen) par bhejna hai
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <input
                  ...
                  className="w-full px-4 py-3 bg-transparent border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 transition"
                />
                <p className="text-[14px] text-purple-400 mt-2 text-center">Password Must Contain At Least 8 Characters</p>
              </div>
